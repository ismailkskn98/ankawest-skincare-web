...
export function ProductCard({ product, variant = "default" }) {
  ...
  const labelClassName = isCarousel
    ...
    : "line-clamp-2 max-w-full rounded-full bg-site-paper px-2 py-1 text-[0.48rem] leading-[1.25] font-extralight tracking-[0.06em] text-site-ink uppercase sm:px-3.5 sm:py-1.5 sm:text-[0.58rem] sm:tracking-[0.08em] lg:px-4 lg:py-2 lg:text-[0.61rem]";
  const brandClassName = isCarousel
    ...
    : "text-[0.52rem] font-light tracking-[0.09em] text-site-copy uppercase sm:text-[0.6rem] sm:tracking-[0.11em] lg:text-[0.64rem]";
  const titleClassName = isCarousel
    ...
    : "mt-1 max-w-[21ch] text-[clamp(0.92rem,2.8vw,1.4rem)] leading-[1.05] font-extralight text-site-ink sm:mt-1.5 sm:leading-[1.02]";
  const sizeClassName = isCarousel
    ...
    : "pb-0.5 text-right text-[0.56rem] leading-[1.4] text-site-copy sm:pb-1 sm:text-[0.64rem] sm:leading-[1.5] lg:text-[0.68rem]";
