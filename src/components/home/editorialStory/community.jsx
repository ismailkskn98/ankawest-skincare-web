    ...
    >
      <div className="relative z-2" data-motion-group>
        <div className="mx-auto max-w-[1280px]">
          ...
          <div
            className="relative mt-8 min-[768px]:mt-14 min-[768px]:min-h-[clamp(560px,88vw,720px)] min-[1024px]:mt-16 min-[1024px]:min-h-[clamp(640px,72vw,860px)]"
            data-scroll-parallax-section
            data-parallax-strength="1.58"
          >
            <div className="relative min-[768px]:contents">
              <div
                className="community-fixed-visual relative mx-auto aspect-[4/5] w-[min(82vw,420px)] overflow-hidden rounded-[48%_52%_8%_8%/18%_20%_5%_5%] bg-[#d9e0db] min-[768px]:absolute min-[768px]:top-0 min-[768px]:left-1/2 min-[768px]:w-[min(78vw,620px)] min-[768px]:-translate-x-1/2 min-[1024px]:w-[min(70vw,700px)]"
                style={{
              ...
              <figure
                className="absolute top-[6%] left-0 z-2 aspect-square w-[clamp(88px,22vw,140px)] overflow-hidden rounded-[1.25rem] bg-[#edf0ec] min-[768px]:top-[8%] min-[768px]:w-[clamp(96px,14vw,200px)] min-[768px]:rounded-[1.5rem] min-[1024px]:top-[12%] min-[1024px]:w-[clamp(110px,15vw,230px)]"
              ...
              <figure
                className="absolute right-0 bottom-[8%] z-2 aspect-[5/4] w-[clamp(104px,26vw,160px)] overflow-hidden rounded-[1.25rem] bg-[#eee7df] min-[768px]:bottom-[18%] min-[768px]:w-[clamp(112px,15vw,220px)] min-[768px]:rounded-[1.5rem] min-[1024px]:bottom-[10%] min-[1024px]:w-[clamp(130px,16vw,260px)]"
                data-scroll-parallax-layer
            ...
            <div
              className="relative z-2 mt-6 flex flex-col gap-5 min-[768px]:absolute min-[768px]:inset-x-0 min-[768px]:bottom-0 min-[768px]:mt-0 min-[768px]:flex-row min-[768px]:items-end min-[768px]:justify-between min-[768px]:gap-8"
              data-section-reveal
            >
              <p className="max-w-[min(320px,90%)] text-[0.84rem] leading-[1.5] text-site-copy min-[768px]:max-w-[280px] min-[768px]:text-[0.9rem]">
