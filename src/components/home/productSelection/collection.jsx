      ...
      >
        ...
        >
          <div>
            ...
            <h3 className="font-canela mt-2.5 text-[clamp(2.35rem,4.8vw,4.2rem)] leading-[0.96] font-light tracking-[-0.035em] text-site-ink lg:mt-3 lg:text-[clamp(2.6rem,3.8vw,4.6rem)]">
              {collection.title}
